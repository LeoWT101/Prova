...
<head>
  ...
  <title>EmoPet MedTech & BioPharma by Leonardo TRONCI</title>
  <script type="module" src="https://unpkg.com/@google/model-viewer/dist/model-viewer.min.js"></script>
  <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css" rel="stylesheet"/>
  <link href="https://fonts.googleapis.com/css2?family=Crimson+Text:wght@400;600;700&family=Montserrat:wght@400;500;600;700&display=swap" rel="stylesheet">
  <style>
    :root {
      --primary: #2a5b8c;
      --secondary: #3a86c9;
    ...
    * {
    ...
    body {
      ...
      line-height: 1.6;
      padding: 0;
      background-image: url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" viewBox="0 0 100 100"><rect width="100" height="100" fill="%23f5f3ef" opacity="1"/><path d="M0,0 L100,100 M100,0 L0,100" stroke="%23e0d6c8" stroke-width="0.5" opacity="0.1"/></svg>');
    }
    ...
    @media print {
      ...
      .article-inner p, .article-inner ul {
...
<div class="satellite-section">
  ...
  <!-- Contatti visibili solo in stampa -->
...
A VR/AR headset with an interactive display showing Fritz and Lulù, the holographic emotional support pets.
...
<footer>
  ...
  <!-- JS per la simulazione clinica -->
  <script>
    function launchStory(mood) {
      const out = document.getElementById("story-area");
      let char, msg, act, illu;
      switch (mood) {
        case "anxious":
          char="🦮 Fritz"; 
          msg="Take a deep breath… I'll stay with you.";
          act="🌬️ Bubbles appear for guided breathing.";
          illu="🏥 Waiting room lit in cool tones, soft music.";
          break;
        case "sad":
          char="🐱 Lulù"; 
          msg="Let's go on a gentle journey together.";
          act="✨ Stars swirl as Lulù tells a story.";
          illu="🌈 Calming rainbow sky projected around.";
          break;
        case "curious":
          char="🦮 Fritz"; 
          msg="Come explore! I'll show you the fun parts.";
          act="🔍 Interactive posters and animated objects.";
          illu="🏥 Pediatric room with play panels.";
          break;
        case "ready":
        default:
          char="🐱 Lulù"; 
          msg="You're brave and ready!";
          act="🎉 Celebration sequence with confetti.";
          illu="🚪 Virtual door opens, Fritz welcomes you.";
      }
      out.innerHTML = `
        <p><strong>${char}</strong>: ${msg}</p>
        <p>${act}</p>
        <p>${illu}</p>
        <br><strong>Now you're ready! 🚑</strong>
      `;
    }
